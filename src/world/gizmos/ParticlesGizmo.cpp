...
ParticleInstance::ParticleInstance(glm::vec3 position, float scale, float blockID): position(position), scale(scale), blockID(blockID), timeExisted(0.0f), body(nullptr)
{
