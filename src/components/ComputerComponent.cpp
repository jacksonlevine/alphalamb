...
{
    auto& io = ImGui::GetIO();
    float originalScale = io.FontGlobalScale;
    ...
    ImGui::SetWindowSize(ImVec2(800, 560), ImGuiCond_Always);
    ...
    if (ImGui::BeginMenuBar())
    {
        if (ImGui::BeginMenu("File"))
        {
            ...
            {
                // No action needed for FBO context
            }
            ImGui::EndMenu();
        }
    ...
    io.FontGlobalScale = originalScale;
}
